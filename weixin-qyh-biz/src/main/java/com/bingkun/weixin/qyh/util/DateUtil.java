...
public class DateUtil {
	...
	public static final String DATE_PATTERN_ZH = "yy年MM月dd日";
	...
	public static String formatDate (String date, String pattern){
		return  DateUtil.date2String(DateUtil.coverString2Date(date),pattern);
	}
	...
	/**
	 * 两个字符串的时间比较，不符合HH:mm:ss的字符串比较都认为是相等的时间
	 * @param value1
	 *            待比较的字符串1
	 * @param value2
	 *            待比较的字符串2
	...
	public static int compareTime(String value1, String value2) {
		String staticDate = "2000-01-01 ";
		// 比较字符串必须为时间格式HH:mm:ss
		if(!checkDate(value1, TIME_PATTERN) || !checkDate(value2, TIME_PATTERN)) {
			return 0;
		}
		return compareDate(staticDate+value1, staticDate+value2);
	}
	 ...
	 * @return
	 */
	public static Long getSecondBetween(String value1, String value2) {
		Date d1 = coverString2Date(value1);
		Date d2 = coverString2Date(value2);
...
//		return (d1.getTime() - d2.getTime()) / (1000 * 60 * 60 * 24);  
	...
	public static void main(String[] args) {
		// yyyy-MM-dd HH:mm:ss
		String value1 = "2014-01-13 09:40:00";
		String value2 = "2014-01-13 09:48:00";
		Long sec = getSecondBetween(value1, value2);
    ...
    public static int getWeekIndex(String date){
    	Date date1 = DateUtil.coverString2Date(date);
